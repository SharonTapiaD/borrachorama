...
if ($nombre === '' || $descripcion === '' || $categoria_id === 0 || $precio <= 0 || $estrategia === '') {
    echo json_encode([
        "status" => "error",
...
// Insertar en la BD
$sql = "INSERT INTO productos (categoria_id, nombre, descripcion, imagen, precio, stock, estrategia, estatus)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);
$stmt->bind_param("isssdisi", $categoria_id, $nombre, $descripcion, $imagenRuta, $precio, $stock, $estrategia, $estatus);
